...
EXPERIMENT_NAME="VATEX-TESTING-PER-EPOCH-METRICS_v10"
...
deepspeed main_deepspeed_gpt5_fix_copy.py --num_gpus $NUM_GPU \
    ...
    # epoch 9 NEXT
    # --do_train --do_val \
    # --resume_from_universal /data2/juve/yo/psc_ref_run/universal_epoch_5 \
